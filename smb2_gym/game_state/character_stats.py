...
class CharacterStats:
    """Base class for character statistics and abilities."""

    # Pick-up speeds for 6 frames of pulling animation
    pickup_speeds: list[int]
...
class MarioStats(CharacterStats):
    """Mario's character statistics."""
...
class ToadStats(CharacterStats):
    """Toad's character statistics."""
...
class LuigiStats(CharacterStats):
    """Luigi's character statistics."""
...
class PrincessStats(CharacterStats):
    """Princess's character statistics."""
...
# Character ID mapping (0=Mario, 1=Princess, 2=Toad, 3=Luigi)
